...
const Nav = (props: Props) => {
  ...
  return (
    <>
      <div className='sticky top-0 z-40 flex pt-5 lg:pt-1 bg-white lg:h-[70px]  lg:flex-row justify-between   items-center pb-4 px-2  md:mb-8 md:px-5 lg:mb-10 lg:px-10 md:rounded-md'>
        {/* logo */}
